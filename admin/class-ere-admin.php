...
if (!class_exists('ERE_Admin')) {
    ...
    class ERE_Admin
    {
                            ...
                            'fields' => array(
                                ...
                                array(
                                    ...
                                    'fields' => array(
                                        ...
                                        array(
                                            'id' => "{$meta_prefix}property_kitchens",
                                            'title' => esc_html__('Kitchens', 'essential-real-estate'),
                                            'type' => 'text',
                                            'pattern' => "{$format_number}",
                                            'default' => '',
                                        ),
        ...
        public function register_taxonomy($taxonomies)
        {
            ...
            $taxonomies['property-hometype'] = array(
                'post_type' => 'property',
                'label' => esc_html__('Property Home Type', 'essential-real-estate'),
                'singular_name' => esc_html__('Property Home Type', 'essential-real-estate'),
                'rewrite' => array(
                    'slug' => apply_filters('ere_property_hometype_slug', 'property-hometype'),
                ),
            );
            $taxonomies['property-leaseterm'] = array(
                'post_type' => 'property',
                'label' => esc_html__('Property Lease Term', 'essential-real-estate'),
                'singular_name' => esc_html__('Property Lease Term', 'essential-real-estate'),
                'rewrite' => array(
                    'slug' => apply_filters('ere_property_leaseterm_slug', 'property-leaseterm'),
                ),
            );
            ...
            return apply_filters('ere_register_option_url_slugs', array(
                ...
                'fields' => array_merge(
                    ...
                    array(
                        ...
                        array(
                            'id' => 'property_hometype_url_slug',
                            'title' => esc_html__('Property Home Type Slug', 'essential-real-estate'),
                            'type' => 'text',
                            'default' => 'property-hometype',
                        ),
                        array(
                            'id' => 'property_leaseterm_url_slug',
                            'title' => esc_html__('Property Lease Term Slug', 'essential-real-estate'),
                            'type' => 'text',
                            'default' => 'property-leaseterm',
                        ),
                        array(
                            ...
                            'fields' => array(
                                array(
                                    ...
                                    'options' => array(
                                        ...
                                        'property_hometype' => esc_html__('Home Type', 'essential-real-estate'),
                                        'property_leaseterm' => esc_html__('Lease Term', 'essential-real-estate'),
