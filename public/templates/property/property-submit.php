...
<section class="ere-property-multi-step">
    <?php
    $layout = ere_get_option('property_form_sections', array('about_your_property', 'about_lease', 'rental_fare', 'house_rules', 'household_facilities', 'title_des', 'location', 'type', 'price', 'features', 'details', 'media', 'floors', 'contact'));
        ...
        foreach ($layout as $value):
            ...
            switch ($value) {
                ...
                case 'household_facilities':
                    $step_name=esc_html__('Household Facilities', 'essential-real-estate');
                    break;
                case 'title_des':
