...
$layout = $column = $address_enable = $title_enable = $city_enable = $leaseterm_enable = $hometype_enable = $type_enable = $status_enable = $bedrooms_enable =
...
extract(shortcode_atts(array(
    ...
    'status_enable' => 'true',
    'type_enable' => 'true',
    'hometype_enable' => 'true',
    'leaseterm_enable' => 'true',
    'title_enable' => 'true',
    'address_enable' => 'true',
    'country_enable' => '',
    'state_enable' => '',
...
$request_hometype = isset($_GET['hometype']) ? $_GET['hometype'] : '';
$request_leaseterm = isset($_GET['leaseterm']) ? $_GET['leaseterm'] : '';
                        ...
                        if ($search_fields): foreach ($search_fields as $field) {
                            switch ($field) {
                                ...
                                case 'property_type':
                                    ...
                                    break;
                                case 'property_hometype':
                                    if ($hometype_enable == 'true') {
                                        ere_get_template('property/search-fields/' . $field . '.php', array(
                                            'css_class_field' => $css_class_field,
                                            'request_hometype' => $request_hometype
                                        ));
                                    }
                                    break;
                                case 'property_leaseterm':
                                    if ($leaseterm_enable == 'true') {
                                        ere_get_template('property/search-fields/' . $field . '.php', array(
                                            'css_class_field' => $css_class_field,
                                            'request_leaseterm' => $request_leaseterm
                                        ));
                                    }
                                    break;
                                case 'property_title':
